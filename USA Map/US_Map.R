...
#Add hate crime categories
racism$HC<-""
racism$HC[1:11]<-"High HC"
racism$HC[12:41]<-"Medium HC"
racism$HC[42:100]<-"Low HC"
...
ggplot() + 
  ...
  coord_fixed(1.3)+
  geom_point(data=racism, aes(x=lon, y=lat, color=HC, size=Total.number.of.Tweets.made.over.6.years))+
